...
class NativePageViewController {
  ...
  static const String channelName = "test_flip_native";

  static late ContentLoader contentLoader;
  ...
  static final MethodChannel _channel = _buildChannel();
  ...
  static Future<T> load<T>(int pageIndex) async {
    return _channel.invokeMethod<T>('load', pageIndex) as Future<T>;
  }
