...
public class SwiftTestFlipNativePlugin: NSObject, FlutterPlugin {
    ...
    static let channelName = "test_flip_native"
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let instance = SwiftTestFlipNativePlugin(flutterAppMessenger: registrar.messenger())
    ...
    public init(flutterAppMessenger: FlutterBinaryMessenger) {
         flutterAppChannel = FlutterMethodChannel(name: SwiftTestFlipNativePlugin.channelName, binaryMessenger: flutterAppMessenger)
    }
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "show":
            if let parameters = Parameters.parse(arguments: call.arguments) {
                SwiftTestFlipNativePlugin.show(
    ...
    private func hide() {
        SwiftTestFlipNativePlugin.hide()
    ...
    private func createFlutterPageView(index: Int, pageRouterName: String) -> UIViewController {
        ...
        let pageChannel = FlutterMethodChannel(name: SwiftTestFlipNativePlugin.channelName, binaryMessenger: flutterPageView as! FlutterBinaryMessenger)
...
extension SwiftTestFlipNativePlugin {
...
extension SwiftTestFlipNativePlugin: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
